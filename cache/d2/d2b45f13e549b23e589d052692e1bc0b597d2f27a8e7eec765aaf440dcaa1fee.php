...
class __TwigTemplate_d534e780a3405f81b7a301515ca05a082f59cb32b2db13e4a3cf595a461c893d extends Template
{
    private $source;
    private $macros = [];
    ...
    <form method=\"post\" enctype=\"multipart/form-data\" class=\"overflow-auto\">
        ...
        <div class=\"row fileupload-buttonbar\">
            <div class=\"col-md-7\">
                <div class=\"card p-3 mb-3 bg-light\">
                    ...
                    ";
        echo "   ";
        if (twig_get_attribute($this->env, $this->source, ($context["currentUser"] ?? null), "featureEnabled", [0 => "folder.view"], "method", false, false, false, 47)) {
            echo " ";
            // line 56
            echo "
                    <div class=\"row\">
        ...
        echo "
                ...
                {{#if folderSelector}}
                 ";
        echo "   ";
        if (twig_get_attribute($this->env, $this->source, ($context["currentUser"] ?? null), "featureEnabled", [0 => "folder.view"], "method", false, false, false, 78)) {
            echo " ";
            // line 80
            echo "
...
{% for (var i=0, file; file=o.files[i]; i++) { %}
    <tr class=\"template-upload\">
        ...
        <td class=\"row\">
            ...
            <div class=\"title col-12 mb-2 col-xl-6\" title=\"Tags\">
                ";
        if (twig_get_attribute($this->env, $this->source, ($context["currentUser"] ?? null), "featureEnabled", [0 => "tag.tagging"], "method", false, false, false, 270)) {
            // line 271
...
";
    ...
    {
        return array (  463 => 331,  423 => 310,  416 => 271,  398 => 270,  362 => 252,  219 => 218,  212 => 80,  185 => 78,  171 => 56,  140 => 47,  137 => 19,  127 => 16,  118 => 13,  110 => 12,  102 => 11,  94 => 10,  86 => 9,  78 => 8,  70 => 7,  62 => 6,  54 => 5,  46 => 4,  37 => 3,);
    }

    public function getSourceContext()
    {
        return new Source("", "include-file-upload.twig", "/srv/xibo-cms/views/include-file-upload.twig");
    }
}
