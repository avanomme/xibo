...
/* install-step1.twig */
class __TwigTemplate_fbe52da5ee51e5aff7725b6b9818fcb7 extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["check"]) {
            ...
            echo "</td>
                        <td>
                            ";
            // line 47
            if ((twig_get_attribute($this->env, $this->source, $context["check"], "status", [], "any", false, false, false, 47) == 0)) {
                // line 48
                echo "                                <span class=\"fa fa-times\"></span>
                            ";
