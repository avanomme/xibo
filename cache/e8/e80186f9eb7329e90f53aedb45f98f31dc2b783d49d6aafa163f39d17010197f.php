...
class __TwigTemplate_6f69dc4b8f859e1d5ee6c2303493e51694c47995b1780b818678d8b8f62d3a5c extends Template
{
    private $source;
    private $macros = [];
    ...
    <a id=\"navbarNotificationMenuLink\" href=\"#\" class=\"nav-link notification-drawer-icon\" data-toggle=\"dropdown\">
        ...
        // line 3
        if ((1 === twig_compare(($context["notificationCount"] ?? null), 0))) {
    ...
    <div class=\"dropdown-menu dropdown-menu-right notification-drawer\">
        ...
        ";
        // line 18
        if (twig_get_attribute($this->env, $this->source, ($context["currentUser"] ?? null), "featureEnabled", [0 => "notification.centre"], "method", false, false, false, 18)) {
            // line 19
            echo "            <div class=\"dropdown-divider\"></div>
    ...
    {
        return new Source("", "authed-notification-drawer.twig", "/srv/xibo-cms/views/authed-notification-drawer.twig");
    }
}
